...
<head>
    ...
    <title>Admin Panel Details | Bootstrap 5</title>
    ...
    <section id="action" class="py-4 mb-4 bg-light">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <a href="#" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#addUserModal">
                        <em class="fa fa-remove"></em> Delete Post
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-header">
                            <h4><em class="fa fa-edit"></em> Edit Post</h4>
                        </div>
                        <div class="card-body">
                            <form>
                                <div class="form-group mb-3">
                                    <label for="title">Title</label>
                                    <input type="text" value="Post One" class="form-control">
                                </div>
                                <div class="form-group mb-3">
