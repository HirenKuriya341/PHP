...
<head>
    ...
    <title>Admin Panel Users | Bootstrap 5</title>
...
<body>
    ...
    <!-- MAIN HEADER -->
    <header id="main-header" class="py-2 bg-warning text-light">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Hiren Kuriya</td>
                                    <td>hirenkuriya@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Ankit Rudani</td>
                                    <td>ankitrudani@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Smit Solanki</td>
                                    <td>smitsolanki@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Ajnan Khan</td>
                                    <td>ajnankhan@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Jenish Chauhan</td>
                                    <td>jenishchauhan@gmail.com</td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Jaydeep Chitroda</td>
                                    <td>jaydeepchitroda@gmail.com</td>
                                </tr>
                            </tbody>
                        </table>
